...
# ------------------ Swin Transformer Block (with FuzzyGatedAttention + GELU MLP) ------------------
...
state_path = "/content/fuzzy_swinvit_encoder_statewithoutMish.pt"
...
encoder_cpu.eval()
script_path = "/content/fuzzy_swinvit_encoder_scriptedWithoutMish.pt"
try:
...
drive_state_path = os.path.join(drive_dir, "fuzzy_swinvit_encoder_statewithoutMish.pt")
